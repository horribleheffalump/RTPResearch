...
for i in range(0, len(tExp)-1):
    if (Prob1Exp[i] + Prob2Exp[i] + Prob3Exp[i] > 0):
        ...
        P1Exp.append(Prob1Exp[i])
        P2Exp.append(Prob2Exp[i])
        P3Exp.append(Prob3Exp[i])
...
ax1 = subplot(311)
ax1.plot(tshortExp, P1Exp, color='black', alpha = 0.4, linewidth=3.0)
...
ax2.plot(tshortExp, P2Exp,color='lightgray', linewidth=3.0)
...
ax3.plot(tshortExp, P3Exp, color='gray',linewidth=3.0)
...
savefilename = u"D:/Наука/_Статьи/__в работе/2015 - new2an - rus/pic_estimates_both.pdf";
