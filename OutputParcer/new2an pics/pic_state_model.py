...
ax1.plot(t, 0.014*ones, 'k--', linewidth=0.75)
ax1.plot(t, 0.05*ones, 'k--', linewidth=0.75)
...
#savefilename = u"D:/Наука/_Статьи/__в работе/2015 - BB-LNCS/pic1_state_model.pdf";
