...
#filename = u"../Data/Linphone_3g_20min_720p_2/Linphone_3g_20min_720p_2_540801797_(91.121.209.194-to-10.4.44.101)_V_frames.txt"
#filename = u"../Data/Linphone_3g_20min_720p_2/Linphone_3g_20min_720p_2_540801797_(91.121.209.194-to-10.4.44.101)_V_frames.txt"
...
#filename = u"../Data/Linphone_3g_20min_720p_2/Estimate_1.txt" #Estimate_1 0.01, Estimate_2 0.001  
#filename = u"../Data/Linphone_3g_20min_720p_2/Estimate_1.txt" #Estimate_1 0.01, Estimate_2 0.001  
#filename = "../Data/Linphone_3g_20min_720p_4/Estimate_2.txt" #Estimate_2 0.01, Estimate_3 0.001  
...
#ax1.fill_between(t, low, up, where=E==ones, color='red', alpha = 0.3, linewidth=0.0);
#ax1.fill_between(t, low, up, where=E==ones*2, color='grey', alpha = 0.3, linewidth=0.0);
#ax1.fill_between(t, low, up, where=E==o, color='grey', alpha = 0.3, linewidth=0.0);
ax1.set_yticks([0,1])
ax1.set_ylim(lb,ub)
ax1.text(-110, 0.5, '$i=1$')

ax2 = subplot(312, sharex=ax1)
ax2.plot(t,Prob2,color='black')
#ax2.fill(t, E2, color='red', alpha = 0.3, linewidth=0.0);
#ax2.fill_between(t, low, up, where=E==o, color='green', alpha = 0.3, linewidth=0.0);
ax2.fill_between(t, low, up, where=E==ones, color='black', alpha = 0.4, linewidth=0.0);
#ax2.fill_between(t, low, up, where=E==ones*2, color='grey', alpha = 0.3, linewidth=0.0);
#ax2.fill_between(t, low, up, where=E==ones, color='grey', alpha = 0.3, linewidth=0.0);
ax2.set_yticks([0,1])
ax2.set_ylim(lb,ub)
ax2.text(-110, 0.5, '$i=2$')


ax3 = subplot(313, sharex=ax1)
ax3.plot(t,Prob3,color='black')
#ax3.fill(t, E3, color='grey', alpha = 0.3, linewidth=0.0);
#ax3.fill_between(t, low, up, where=E==o, color='green', alpha = 0.3, linewidth=0.0);
#ax3.fill_between(t, low, up, where=E==ones, color='red', alpha = 0.3, linewidth=0.0);
ax3.fill_between(t, low, up, where=E==ones*2, color='black', alpha = 0.7, linewidth=0.0);
ax3.set_yticks([0,1])
ax3.set_ylim(lb,ub)
ax3.text(-110, 0.5, '$i=3$')
...
#savefilename = u"D:/Наука/_Статьи/__в работе/2015 - BB-LNCS/pic4_estimates_model.pdf";
