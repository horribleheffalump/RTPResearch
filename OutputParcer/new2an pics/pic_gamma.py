...
#==== 0 0 ======
filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_0/0_0_0_gamma_data.txt"
gamma_data000 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_0/0_0_0_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a000,b000 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_0/0_1_0_gamma_data.txt"
gamma_data010 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_0/0_1_0_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a010,b010 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_0/0_2_0_gamma_data.txt"
gamma_data020 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_0/0_2_0_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a020,b020 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

#==== 0 1 ======
filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_1/0_0_1_gamma_data.txt"
gamma_data001 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_1/0_0_1_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a001,b001 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_1/0_1_1_gamma_data.txt"
gamma_data011 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_1/0_1_1_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a011,b011 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_1/0_2_1_gamma_data.txt"
gamma_data021 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_1/0_2_1_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a021,b021 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

#==== 0 2 ======
filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_2/0_0_2_gamma_data.txt"
gamma_data002 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_2/0_0_2_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a002,b002 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_2/0_1_2_gamma_data.txt"
gamma_data012 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_2/0_1_2_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a012,b012 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

#filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_2/0_2_2_gamma_data.txt"
#gamma_data022 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_2/0_2_2_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a022,b022 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

#==== 1 0 ======
filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_0/1_0_0_gamma_data.txt"
gamma_data100 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_0/1_0_0_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a100,b100 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_0/1_1_0_gamma_data.txt"
gamma_data110 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_0/1_1_0_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a110,b110 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_0/1_2_0_gamma_data.txt"
gamma_data120 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_0/1_2_0_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a120,b120 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

#==== 1 1 ======
filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_1/1_0_1_gamma_data.txt"
gamma_data101 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_1/1_0_1_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a101,b101 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_1/1_1_1_gamma_data.txt"
gamma_data111 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_1/1_1_1_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a111,b111 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_1/1_2_1_gamma_data.txt"
gamma_data121 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_1/1_2_1_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a121,b121 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

#==== 1 2 ======
filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_2/1_0_2_gamma_data.txt"
gamma_data102 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_2/1_0_2_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a102,b102 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_2/1_1_2_gamma_data.txt"
gamma_data112 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_2/1_1_2_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a112,b112 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_2/1_2_2_gamma_data.txt"
gamma_data122 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_2/1_2_2_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a122,b122 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)


#==== 2 0 ======
filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_0/2_0_0_gamma_data.txt"
gamma_data200 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_0/2_0_0_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a200,b200 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_0/2_1_0_gamma_data.txt"
gamma_data210 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_0/2_1_0_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a210,b210 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_0/2_2_0_gamma_data.txt"
gamma_data220 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_0/2_2_0_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a220,b220 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

#==== 2 1 ======

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_1/2_0_1_gamma_data.txt"
gamma_data201 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_1/2_0_1_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a201,b201 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_1/2_1_1_gamma_data.txt"
gamma_data211 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_1/2_1_1_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a211,b211 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_1/2_2_1_gamma_data.txt"
gamma_data221 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_1/2_2_1_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a221,b221 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

#==== 2 2 ======

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_2/2_0_2_gamma_data.txt"
gamma_data202 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_2/2_0_2_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a202,b202 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_2/2_1_2_gamma_data.txt"
gamma_data212 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_2/2_1_2_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
a212,b212 = np.loadtxt(filename, delimiter = ' ', usecols=(0,1), unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_2/2_2_2_gamma_data.txt"
gamma_data222 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_2/2_2_2_gamma_params.txt" #Estimate_1 0.01, Estimate_2 0.001  
