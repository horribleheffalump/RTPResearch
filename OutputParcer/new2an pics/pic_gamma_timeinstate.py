...
#==== 0 0 ======
filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_timeinstate_data.txt"
gamma_data0 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/0_timeinstate_params.txt"
a0 = np.loadtxt(filename, delimiter = ' ', unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_timeinstate_data.txt"
gamma_data1 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/1_timeinstate_params.txt"
a1 = np.loadtxt(filename, delimiter = ' ', unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_timeinstate_data.txt"
gamma_data2 = np.loadtxt(filename, unpack=True, dtype=float)

filename = u"../Data/data 2015-12-7 21-29 - 3g 20min - first quater/2_timeinstate_params.txt"
...
#savefilename = u"D:/Наука/_Статьи/__в работе/2015 - BB-LNCS/pic2_timesinstates_hists.pdf";
